...
ac2 = AnswerChoice.create!({ question_id: q1.id, text:'2 slightly unsatisfied' })
ac3 = AnswerChoice.create!({ question_id: q1.id, text:'3 neutral' })
ac4 = AnswerChoice.create!({ question_id: q1.id, text:'4 slightly satisfied' })
...
ac15 = AnswerChoice.create!({ question_id: q4.id, text:'2 Slightly hard to find' })
ac16 = AnswerChoice.create!({ question_id: q4.id, text:'3 neutral' })
ac17 = AnswerChoice.create!({ question_id: q4.id, text:'4 fairly easy to find' })
...
ac20 = AnswerChoice.create!({ question_id: q5.id, text:'2 slightly unsatisfied' })
ac21 = AnswerChoice.create!({ question_id: q5.id, text:'3 neutral' })
ac22 = AnswerChoice.create!({ question_id: q5.id, text:'4 slightly satisfied' })
